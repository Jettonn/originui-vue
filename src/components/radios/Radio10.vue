...
<template>
  <RadioGroup class="gap-2" v-model="selectedValue">
    ...
    <!-- Radio card #2 -->
    <div
      class="relative flex items-center gap-2 rounded-lg border border-input p-4 shadow-sm shadow-black/[.04] has-[[data-state=checked]]:border-ring"
    >
      <RadioGroupItem
        value="r2"
        id="radio-10-r2"
