...
<template>
  <div class="space-y-2">
    ...
    <TagsInputRoot
      v-model="modelValue"
      class="flex flex-row flex-wrap items-center w-full border text-xs file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-64 border-input rounded-lg bg-background shadow-xs shadow-black/[.04] ring-offset-background transition-shadow focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/30 focus-within:ring-offset-2 p-1 gap-1"
    >
      <TagsInputItem
      ...
      <TagsInputInput
        ...
        class="flex rounded-md border-input py-1 text-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-64 border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0 flex-1 w-full min-w-[80px] focus-visible:outline-hidden shadow-none px-2 h-7"
      />
    </TagsInputRoot>
