              ...
              >
                ...
                >
                  <DatePickerCellTrigger
                    ...
                    :class="
                      cn(
                        'relative flex size-9 items-center justify-center whitespace-nowrap rounded-lg border border-transparent p-0 text-sm font-normal text-foreground ring-offset-background transition-shadow focus-visible:outline-hidden disabled:pointer-events-none unavailable:pointer-events-none focus-visible:z-10 data-focus-visible:border-ring hover:bg-accent data-selected:bg-primary hover:text-foreground data-selected:text-primary-foreground data-unavailable:line-through data-disabled:opacity-30 data-unavailable:opacity-30 data-focus-visible:outline-hidden data-focus-visible:ring-2 data-focus-visible:ring-ring/30 data-focus-visible:ring-offset-2 data-invalid:data-selected:[&:not([data-hover])]:bg-destructive data-invalid:data-selected:[&:not([data-hover])]:text-destructive-foreground',
