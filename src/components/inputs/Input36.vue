...
<template>
  <div class="space-y-2">
    <Label class="text-sm font-medium text-foreground" for="date-field">Birthday</Label>
    <DateFieldRoot
      id="date-field"
      v-slot="{ segments }"
      class="relative inline-flex h-9 w-full items-center overflow-hidden whitespace-nowrap rounded-lg border border-input bg-background px-3 py-2 text-sm shadow-xs shadow-black/[.04] ring-offset-background transition-shadow focus-within:border-ring focus-within:outline-hidden focus-within:ring-2 focus-within:ring-ring/30 focus-within:ring-offset-2 data-disabled:opacity-64"
    >
