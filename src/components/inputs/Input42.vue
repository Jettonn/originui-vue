...
<template>
  <div class="space-y-2">
    <Label class="text-sm text-gray9" for="date-range-picker">Date range picker</Label>
    <DateRangePickerRoot id="date-range-picker">
      <div class="flex">
        <DateRangePickerField
          v-slot="{ segments }"
              ...
              >
                ...
                >
                  <DateRangePickerCellTrigger
                    ...
                    :class="
                      cn(
                        'relative flex size-9 items-center justify-center whitespace-nowrap rounded-lg border border-transparent p-0 text-sm font-normal text-foreground ring-offset-background duration-150 [transition-property:border-radius,box-shadow] focus-visible:outline-hidden data-disabled:pointer-events-none data-unavailable:pointer-events-none data-focus-visible:z-10 data-selected:rounded-none data-highlighted:rounded-none data-selection-end:rounded-e-lg data-highlighted-end:rounded-e-lg data-selection-start:rounded-s-lg data-focus-visible:border-ring hover:bg-accent data-invalid:bg-red-100 data-selected:bg-accent data-highlighted:bg-accent hover:text-foreground data-selected:text-foreground data-highlighted:text-foreground data-unavailable:line-through data-disabled:opacity-30 data-unavailable:opacity-30 data-focus-visible:outline-hidden data-focus-visible:ring-2 data-focus-visible:ring-ring/30 data-focus-visible:ring-offset-2 data-invalid:data-selection-end:bg-destructive data-invalid:data-selection-start:bg-destructive data-selection-end:bg-primary data-highlighted-end:bg-primary data-selection-start:bg-primary data-invalid:data-selection-end:text-destructive-foreground data-invalid:data-selection-start:text-destructive-foreground data-selection-end:text-primary-foreground data-highlighted-end:text-primary-foreground data-selection-start:text-primary-foreground',
