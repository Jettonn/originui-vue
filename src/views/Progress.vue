  ...
  <main>
    <div class="px-4 sm:px-6">
      <div class="mx-auto w-full max-w-6xl">
        <PageHeader
          title="Progress Components - COSS UI"
          heading="Progress"
          description="A growing collection of progress components built with Vue and TailwindCSS."
        >
          A growing collection of {{ totalComponents }} progress components built with
        ...
        >
          <DemoComponent
            v-for="component in progressFiles"
            :key="component"
...
const progressFiles = ref(['Progress01', 'Progress02'])
const progressDirectory = 'progress'

const totalComponents = computed(() => progressFiles.value.length)
</script>
