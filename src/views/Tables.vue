  ...
  <main>
    <div class="px-4 sm:px-6">
      <div class="mx-auto w-full max-w-6xl">
        <PageHeader
          title="Table Components - COSS UI"
          heading="Table"
          description="A growing collection of table components built with Vue and TailwindCSS."
        >
          A growing collection of {{ totalComponents }} table components built with
        ...
        >
          <DemoComponent
            v-for="component in tableFiles"
            :key="component"
            class="group/item relative col-span-12 flex items-center justify-center"
